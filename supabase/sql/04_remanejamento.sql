-- Remanejamento de verba entre itens de orçamento. Referência original desta
-- migração — veja supabase/migrations/20260827130000_remanejamento_verba.sql
-- para o que de fato é aplicado num projeto já conectado pelo Lovable.
